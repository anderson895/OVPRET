    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        '&::before': {
          ...
          borderRadius: '50%',
          border: '35px solid rgba(245,168,0,0.06)',
        },
      }}>
        {/* MSU Seal */}
        <Box sx={{
      ...
      <Box sx={{
        ...
        <Paper elevation={0} sx={{
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, justifyContent: 'center', mb: 3 }}>
            <Box sx={{ width: 72, height: 72, borderRadius: '50%', border: '2px solid rgba(123,28,46,0.3)', overflow: 'hidden', bgcolor: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
