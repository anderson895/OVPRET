...
const FilterChip: React.FC<{ label: string; active: boolean; onClick: () => void }> = ({ label, active, onClick }) => (
  <Box onClick={onClick} sx={{ px: 1.5, py: 0.4, borderRadius: 0.8, fontSize: '0.6rem', fontWeight: 700, letterSpacing: '0.8px', textTransform: 'uppercase', cursor: 'pointer', border: '1px solid', transition: 'all 0.15s', borderColor: active ? '#c9952a' : '#243040', color: active ? '#c9952a' : '#8fa3b8', bgcolor: active ? '#162230' : 'transparent', '&:hover': { borderColor: '#c9952a', color: '#c9952a' } }}>
    {label}
  </Box>
)
  ...
  return (
    <Box>
      ...
      <Paper sx={{ bgcolor: '#0f1e2e' }}>
        {/* Header */}
        <Box sx={{ p: '18px 24px', borderBottom: '1px solid #243040', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1.5 }}>
          <Box>
        ...
        {/* Filters */}
        <Box sx={{ px: 3, py: 2, borderBottom: '1px solid #243040', display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
